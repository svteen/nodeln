...
// var UserListCtrl = angular.module('UserListCtrl', []);
myApp.controller('UserListCtrl', ['$scope', '$http', '$templateCache', function($scope, $http, $templateCache){
  var method = 'POST';
  var inserturl = 'http://localhost:3000/insertUser';// URL where the Node.js server is running
  $scope.codeStatus = "";
  ...
  $scope.save = function() {
    ...
    $scope.list = function() {
      var url = 'http://localhost:3000/getUsers';// URL where the Node.js server is running
